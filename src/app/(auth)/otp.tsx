...
export default function OtpScreen() {
  ...
  const handleOtpChange = (value: string) => {
    ...
    if (clean.length === 6) {
      // Small delay so the user can see the completed code
      setTimeout(() => {
        handleVerify(clean);
      }, 120);
    }
  ...
  const handleVerify = async (
    ...
    if (!userId) {
      Alert.alert(
        "Verification Error",
        "Your registration information is missing. Please return to registration and try again."
      );
      return;
    }
  ...
  const handleResend = async () => {
    if (!userId) {
      Alert.alert(
        "Error",
        "Your registration information is missing."
      );
      return;
    }
        ...
        >
          ...
          <View style={styles.securityNote}>
            ...
            <View style={styles.securityContent}>
              ...
              >
                TUPC-OrderUp will never ask you
